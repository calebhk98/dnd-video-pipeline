    ...
    const ref = {
        submit(endpointId, options) {
            return __awaiter(this, void 0, void 0, function* () {
                const { webhookUrl, priority, hint, headers: extraHeaders } = options, runOptions = __rest(options, ["webhookUrl", "priority", "hint", "headers"]);
                ...
                return (0, request_1.dispatchRequest)({
                    ...
                    headers: Object.assign(Object.assign(Object.assign({}, extraHeaders), { "x-fal-queue-priority": priority !== null && priority !== void 0 ? priority : "normal" }), (hint && { "x-fal-runner-hint": hint })),
                    input: input,
                    config,
                    options: {
