"""
Deepseek Tool Schema Definitions
==================================
OpenAI-format tool/function schemas used by DeepseekProcessor for structured output.
Centralising them here keeps method bodies focused on logic rather than schema plumbing.
"""

_STORYBOARD_ITEM_SCHEMA = {
	"type": "object",
	"properties": {
...
_PRODUCTION_SCRIPT_ITEM_SCHEMA = {
	"type": "object",
	"properties": {
		"scene_number": {"type": "integer"},
		"start_time": {"type": "number"},
	...
	"function": {
		...
		"parameters": {
			...
			"properties": {
				"scenes": {
					"type": "array",
					"items": _PRODUCTION_SCRIPT_ITEM_SCHEMA,
				}
			},
			"required": ["scenes"],
		},
